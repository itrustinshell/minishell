...
SRC =   tokenizer/fill_tokenmatrix.c tokenizer/get_tokens_number.c tokenizer/tokenizer.c\
		...
		executor/executor.c executor/heredoc_utils_2.c executor/pipex.c executor/builtinex.c executor/heredoc.c executor/heredoc_utils.c executor/redirutils.c executor/redirops.c executor/pipeutils_p1.c executor/pipeutils_p2.c\
		test/pipe_test.c test/printmatrix.c\
		utils/init.c utils/free.c utils/list_utils.c utils/cmd_utils.c utils/general_utils.c\
		main.c \
